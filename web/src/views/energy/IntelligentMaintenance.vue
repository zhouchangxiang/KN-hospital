      ...
      <el-row :gutter="15" v-if="TabControl.TabControlCurrent === '设备台账'">
        <el-col :span="24" v-if="!showRepairsForm && !showMaintainForm && !showKeepPlanForm">
          <div class="tableContainer">
            <tableView :tableData="TableData" @getTableData="getEQTable" @repairs="repairs" @handleEQRowClick="handleEQRowClick" @drawUpKeepPlan="drawUpKeepPlan" @seeKeepPlan="seeKeepPlan"></tableView>
          </div>
